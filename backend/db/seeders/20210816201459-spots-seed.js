...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Spots', [
      {	userId:	1, guestCap:	6, address:	"1301 24th St W", city:	"Williston", state:	"North Dakota", zip: 58801, spotName:	"Geraldine's escape", description:	"Basement apartment recently renovated (2020). Pet friendly. Non-smoking", price:	79, lat:	48.166261, lng:	-103.642285, createdAt:	new Date(), updatedAt:	new Date()	},
      {	userId:	2, guestCap:	4, address:	"1007 24th St W Suite 104", city:	"Williston", state:	"North Dakota", zip: 58801, spotName:	"Buntrock's classic", description:	"Just a cot and restroom", price:	69, lat:	48.166301, lng:	-103.638522, createdAt:	new Date(), updatedAt:	new Date()	},
